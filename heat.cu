...
int main( void ) {
	...
	// FOR A SQUARE
        ...
        /* if ((x>300) && (x<600) && (y>310) && (y<601)) // x and y coordinates of the square
            temp[i] = MAX_TEMP;//increasing the temperature at the heat sink points
	*/ 
    ...
    temp[DIM*100+100] = (MAX_TEMP + MIN_TEMP)/2; // change in temp on each side of the square 
    temp[DIM*700+100] = MIN_TEMP;
    temp[DIM*300+300] = MIN_TEMP;
    temp[DIM*200+700] = MIN_TEMP;
    for (int y=800; y<900; y++) { /// the dark blue background 
